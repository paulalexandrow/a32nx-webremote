...
WebRemote for FBW A32NX is a customizable **web-based remote control** for [FlyByWire Simulation's A32NX](https://flybywiresim.com). It works with any modern browser on PCs, tablets or phones.
